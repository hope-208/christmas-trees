...
export default {
  ...
  data() {
    return {
      gifts: [
        {
          label: "@/assets/img/1-label.svg",
          image: "@/assets/img/1-img.svg",
        ...
        {
          label: "@/assets/img/2-label.svg",
          image: "@/assets/img/2-img.svg",
          title: "Детские книжные новинки",
          description:
        ...
        {
          label: "@/assets/img/3-label.svg",
          image: "@/assets/img/3-img.svg",
        ...
        {
          label: "@/assets/img/4-label.svg",
          image: "@/assets/img/4-img.svg",
        ...
        {
          label: "@/assets/img/5-label.svg",
          image: "@/assets/img/5-img.svg",
        ...
        {
          label: "@/assets/img/6-label.svg",
          image: "@/assets/img/6-img.svg",
